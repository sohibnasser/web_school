...
export default function RegisterHere() {
  return (
    ...
    <Form data-aos="fade-left"  data-aos-delay="200" data-aos-duration="2000">
	<Title>Login</Title>
	<form>
		...
		<button style={{backgroundColor : `${theme.primary}` , color : `${theme.whiteSmoke}`}} class="sign">Sign in</button>
	</form>
